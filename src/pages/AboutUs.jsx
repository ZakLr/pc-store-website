...
const AboutUs = () => {
  ...
  const teamMembers = [
    {
      ...
      bio: "Avec 15 ans d'expérience dans la mode, Sarah apporte un leadership visionnaire à Eye Comfort Dz. Diplômée de l'École de la Chambre Syndicale de la Couture Parisienne, elle a travaillé avec des maisons de couture prestigieuses avant de créer sa propre vision de la mode éthique et luxueuse.",
    ...
    },
    {
      ...
      bio: "Léa orchestre notre présence mondiale et nos campagnes créatives. Ancienne directrice marketing chez des marques de Eye Comfort Dz internationales, elle apporte une expertise unique en stratégie de marque et communication digitale.",
  ...
  const milestones = [
    {
      year: "2020",
      title: "Fondation de Eye Comfort Dz",
      description:
        "Sarah Johnson lance Eye Comfort Dz avec une vision claire : créer une mode luxueuse et responsable. Première collection de 50 pièces.",
      icon: "🚀",
    },
    {
      year: "2021",
    ...
    },
    {
      ...
      description:
        "Eye Comfort Dz obtient la certification B-Corporation, reconnaissant nos standards élevés en matière sociale et environnementale.",
      icon: "🏆",
    },
    {
      year: "2023",
      ...
      description:
        "Lancement de notre ligne 'Eco-Eye Comfort Dz' utilisant 100% de matériaux recyclés et biologiques. Prix de l'Innovation Durable.",
      icon: "🌱",
    },
    {
      year: "2024",
  ...
  const awards = [
    ...
    },
    {
      ...
      description:
        "Élue meilleure marque émergente de Eye Comfort Dz pour notre innovation et qualité.",
    },
    {
      year: "2023",
      title: "Certification B-Corp",
  ...
  const sustainability = [
    ...
    },
    {
      ...
      description:
        "Reprise et recyclage de vos anciens vêtements Eye Comfort Dz",
  ...
  return (
    <div className="!min-h-screen !bg-[var(--color-background)] !font-[var(--font-playfair)]">
      ...
      <motion.div
        ...
        className="!pt-20 !relative !bg-[var(--color-background-secondary)] !text-text !overflow-hidden"
      >
        ...
        <div className="!relative !max-w-7xl !mx-auto !px-4 sm:!px-6 lg:!px-8 !py-24">
          <div className="!text-center">
            <motion.h1
              ...
              className="!text-5xl md:!text-7xl !font-[var(--font-playfair)] !font-bold !mb-6 !text-white"
            >
              <span className="!text-primary">PC Store</span>
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, y: 30 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              Depuis 2020, PC Store s'engage à offrir des PC éthiques et
              durables, en mettant l'accent sur la qualité, le style et la
              ...
              <button
                ...
                className={`!px-4 !py-2 !rounded-lg !font-[var(--font-playfair)] !font-medium !transition-colors ${
                  activeTab === tab.key
                    ...
                    : "!text-primary !hover:text-[var(--color-accent)] !hover:bg-[var(--color-secondary)]"
                }`}
              >
                {tab.label}
              </button>
      ...
      <div className="!max-w-7xl !mx-auto !px-4 sm:!px-6 lg:!px-8 !py-16">
        ...
        {activeTab === "story" && (
          ...
          >
            <div className="!grid !grid-cols-1 lg:!grid-cols-2 !gap-16 !items-center !mb-16">
              <div>
                <h2 className="!text-4xl !font-[var(--font-playfair)] !font-bold !text-white !mb-6">
                  Notre Histoire
                </h2>
                <div className="!space-y-6 !text-lg !text-white">
                  <p>
                    Eye Comfort Dz est née d'une vision audacieuse : prouver que
                    Eye Comfort Dz et responsabilité peuvent coexister
                    harmonieusement. En 2020, dans un monde en pleine
                    transformation, Sarah Johnson a imaginé une marque qui
                    transcenderait les conventions de l'industrie de la mode.
                  </p>
                  <p>
                    Inspirée par les ateliers de couture traditionnels parisiens
                    et guidée par les principes du développement durable, Eye
                    Comfort Dz a rapidement évolué d'une start-up passionnée
                    vers une référence mondiale en matière de mode éthique et
                    luxueuse.
                  </p>
                  <p>
                    Aujourd'hui, nous collaborons avec plus de 100 artisans dans
                    15 pays, chacun partageant notre engagement pour
                    l'excellence et la durabilité. Chaque pièce Eye Comfort Dz
                    raconte une histoire - celle de mains expertes, de matériaux
                    nobles et d'un avenir plus responsable.
                  </p>
                </div>
              </div>
            ...
            <div className="!grid !grid-cols-1 md:!grid-cols-3 !gap-8 !mb-16">
              <div className="!bg-[var(--color-secondary)] !p-8 !rounded-lg !shadow-[var(--color-shadow)]">
                ...
                <h3 className="!text-xl !font-[var(--font-playfair)] !font-bold !text-white !mb-4">
                  Notre Mission
                </h3>
        ...
        {activeTab === "values" && (
          ...
          >
            <div className="!text-center !mb-16">
              <h2 className="!text-4xl !font-[var(--font-playfair)] !font-bold !text-white !mb-4">
            ...
            <div className="!grid !grid-cols-1 lg:!grid-cols-2 !gap-8">
              {values.map((value, index) => (
                ...
                >
                  ...
                  <h3 className="!text-2xl !font-[var(--font-playfair)] !font-bold !text-white !mb-4">
                    {value.title}
                  </h3>
                  ...
                  <ul className="!space-y-3">
                    {value.details.map((detail, idx) => (
                      <li key={idx} className="!flex !items-start">
                        <span className="!text-[var(--color-accent)] !mr-3 !mt-1">
                          ✓
                        </span>
          ...
          >
            <div className="!text-center !mb-16">
              ...
              <p className="!text-xl !text-white !max-w-3xl !mx-auto">
                ...
                vie à la philosophie Eye Comfort Dz chaque jour.
              </p>
            </div>
            ...
            <div className="!grid !grid-cols-1 md:!grid-cols-2 lg:!grid-cols-3 !gap-8">
              {teamMembers.map((member, index) => (
                ...
                >
                  ...
                  <div className="!p-6">
                    <h3 className="!text-xl !font-[var(--font-playfair)] !font-bold !text-white !mb-1">
                      {member.name}
                    </h3>
                    ...
                    <div className="!flex !flex-wrap !gap-2">
                      {member.expertise.map((skill, idx) => (
                        <span
                          key={idx}
                          className="!px-3 !py-1 !bg-[var(--color-secondary)] !text-white !rounded-full !text-sm !font-medium"
                        >
                          {skill}
                        </span>
                      ))}
              ...
              {sustainability.map((item, index) => (
                ...
                >
                  <div className="!flex !items-start !mb-6">
                    ...
                    <div>
                      <h3 className="!text-xl !font-[var(--font-playfair)] !font-bold !text-white !mb-2">
                        {item.title}
                      </h3>
        ...
        {activeTab === "timeline" && (
          ...
          >
            <div className="!text-center !mb-16">
              ...
              <p className="!text-xl !text-white !max-w-3xl !mx-auto">
                Découvrez les moments clés qui ont façonné l'histoire de Eye
                Comfort Dz et notre vision pour l'avenir.
              </p>
            </div>
                ...
                >
                  ...
                  >
                    <div className="!bg-white !rounded-lg !shadow-[var(--color-shadow)] !p-6 !hover:shadow-[var(--color-shadow)] !transition-shadow">
                      ...
                      <h3 className="!text-xl !font-[var(--font-playfair)] !font-bold !text-white !mb-3">
                        {milestone.title}
                      </h3>
        ...
        {activeTab === "awards" && (
          ...
          >
              ...
              {awards.map((award, index) => (
                ...
                >
                  <div className="!flex !items-center !mb-4">
                    <span className="!text-3xl !mr-4 !text-[var(--color-accent)]">
                      🏆
                    </span>
            ...
            <div className="!mt-16 !bg-white !rounded-lg !shadow-[var(--color-shadow)] !p-8">
              <h3 className="!text-2xl !font-[var(--font-playfair)] !font-bold !text-white !mb-8 !text-center">
                Nos Certifications
              </h3>
              <div className="!grid !grid-cols-2 md:!grid-cols-4 !gap-8 !text-center">
                {[
                  ...
                  <div key={index} className="!p-4">
                    ...
                    <h4 className="!font-[var(--font-playfair)] !font-bold !text-white">
                      {cert.name}
                    </h4>
        ...
        <div className="!bg-[var(--color-background)] !py-20">
          <div className="!max-w-7xl !mx-auto !px-4 sm:!px-6 lg:!px-8 !text-center">
            ...
            >
              <h2 className="!text-4xl !font-[var(--font-playfair)] !font-bold !text-white !mb-6">
                Rejoignez la Révolution Eye Comfort Dz
              </h2>
              <p className="!text-xl !text-white !mb-10 !max-w-3xl !mx-auto">
                Découvrez une mode qui respecte vos valeurs, valorise
                l'artisanat et préserve notre planète. Chaque achat contribue à
              ...
              <div className="!flex !flex-col sm:!flex-row !gap-4 !justify-center">
                ...
                <motion.button
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="!border-2 !border-[var(--color-border)] !text-white !px-8 !py-4 !rounded-lg !text-lg !font-[var(--font-playfair)] !font-bold !hover:bg-[var(--color-secondary)] !transition-all !duration-300"
                >
                  Nous Contacter
                </motion.button>
              </div>
