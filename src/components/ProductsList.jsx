...
import { sampleClothingProducts } from "./sampleClothingProducts"; // Move your products to a separate file or keep it inline
...
const ProductsList = () => {
  ...
  const fetchStaticProducts = () => {
    setIsLoading(true);
    let filteredProducts = [...sampleClothingProducts];
    if (category)
    ...
    <Box minH="100vh" bg="background">
      <motion.header variants={bgVariants} initial="hidden" animate="visible">
        <Box
          ...
          position="relative"
          style={{
            backgroundImage: `url('https://plus.unsplash.com/premium_photo-1664202525979-80d1da46b34b?q=80&w=1471&auto=format&fit=crop')`,
